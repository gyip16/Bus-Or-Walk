...
class BusStopTableViewControllerOLD: UITableViewController {
    
    var detailViewController: ResultViewController? = nil
    var objects = [Any]()
    ...
    override func viewDidLoad() {
        ...
        if let split = splitViewController {
            ...
            detailViewController = (controllers[controllers.count-1] as! UINavigationController).topViewController as? ResultViewController
        }
    }
